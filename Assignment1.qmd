...
exact_jarowinkler_w <- emWeights(exact_jarowinkler, cutoff = 0.65)
...
exact_levenshtein_w <- emWeights(exact_levenshtein, cutoff = 0.65)
...
exact_phonetic_w <- emWeights(exact_phonetic, cutoff = 0.65)
...
city_block_jarowinkler_w <- emWeights(city_block_jarowinkler, cutoff = 0.65)
...
city_block_levenshtein_w <- emWeights(city_block_levenshtein, cutoff = 0.65)
...
city_block_phonetic_w <- emWeights(city_block_phonetic, cutoff = 0.65)
...
zip_block_jarowinkler_w <- emWeights(zip_block_jarowinkler, cutoff = 0.65)
...
zip_block_levenshtein_w <- emWeights(zip_block_levenshtein, cutoff = 0.65)
...
zip_block_phonetic_w <- emWeights(zip_block_phonetic, cutoff = 0.65)
...
lastname_block_jarowinkler_w <- emWeights(lastname_block_jarowinkler, cutoff = 0.65)
...
lastname_block_levenshtein_w <- emWeights(lastname_block_levenshtein, cutoff = 0.65)
...
lastname_block_phonetic_w <- emWeights(lastname_block_phonetic, cutoff = 0.65)
